...
@transactional_server
  ...
  Scenario: Wait until containerized proxy service is active
    ...
    And I wait until proxy port "8022" is listening on "proxy" container
    And I wait until proxy port "80" is listening on "proxy" container
    And I wait until proxy port "443" is listening on "proxy" container
